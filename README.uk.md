# HEK — Аналізатор журналів мережевого обладнання

Це інструмент для парсингу конфігурацій та журналів мережевого обладнання (Huawei, Cisco, Juniper, Mikrotik та ін.) та генерації уніфікованого звіту й Excel-експортів.
